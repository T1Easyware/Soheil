...
namespace Soheil.Common.Localization
{
    ...
    public static class LocalizationManager
    {
        ...
        static readonly object DefaultResourceManagerSyncRoot = new object();
        ...
        /// </summary>
        static readonly Dictionary<LocalizedProperty, LocalizedValue> LocalizedValues = new Dictionary<LocalizedProperty, LocalizedValue>();
        ...
        static readonly List<ResourceManagerData> ResourceManagers = new List<ResourceManagerData>();
