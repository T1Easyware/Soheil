...
{
    public class ActualCostBarProvider : IItemsProvider<CostBarVm>
    {
        ...
        public ActualCostBarProvider(int count, double pageHeight, CostType costType, DateTimeIntervals dateTimeIntervals, ActualCostReportDataService dataService, CostBarInfo barInfo)
        {
            _count = count;
            BarInfo = barInfo;
            CostType = costType;
