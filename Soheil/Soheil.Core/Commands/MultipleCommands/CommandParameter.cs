...
namespace Soheil.Core.Commands.MultipleCommands
{
		...
		where TEventArgs : RoutedEventArgs
	{
		...
		public new static EventCommandParameter<TCustomParameter, TEventArgs> Cast(object parameter)/*new???*/
		{
	...
	public class PropertyCommandParameter<TCustomParameter, TValue> : CommandParameter<TCustomParameter>
	{
		...
		public new static PropertyCommandParameter<TCustomParameter, TValue> Cast(object parameter)/*new???*/
		{
