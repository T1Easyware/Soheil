...
namespace Soheil.Model
{
    public partial class Product_Defection
    {
        ...
        {
            if (previousValue != null && previousValue.Product_Defection.Contains(this))
            {
                previousValue.Product_Defection.Remove(this);
            }
    
            if (Product != null)
            {
                if (!Product.Product_Defection.Contains(this))
                {
                    Product.Product_Defection.Add(this);
                }
            }
        }
        ...
        private void FixupDefection(Defection previousValue)
        {
            ...
            if (Defection != null)
            {
                if (!Defection.Product_Defection.Contains(this))
                {
                    Defection.Product_Defection.Add(this);
                }
            }
        }
        ...
        private void FixupRoots(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.Product_Defection, this))
                    {
                        item.Product_Defection = null;
                    }
                }
            }
        }
