...
namespace Soheil.Views.PP
{
	...
	public class TaskReportBuilderMarginConverter : IMultiValueConverter
	{
		public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
		{
			if (values[0] == DependencyProperty.UnsetValue) 
				return new Thickness(0);
			var rh = (Core.ViewModels.PP.TaskReportHolderVm)values[0];
			if (rh == null) return new Thickness(0);
			var hoursPassed = (double)values[1];
			var hourZoom = (double)values[2];
			var daysFromStartOfYear = (int)values[3];
			...
			return new Thickness(
				...
				(rh.Task.RowIndex + 1) * 42 + offset.Y, 0, 0);
		}
	...
	public class TaskReportBuilderInProcessMarginConverter : IMultiValueConverter
	{
		public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
		{
			if (values[0] == DependencyProperty.UnsetValue)
				return new Thickness(0);
			var rh = (Core.ViewModels.PP.ProcessReportCellVm)values[0];
			if (rh == null) return new Thickness(0);
			var hoursPassed = (double)values[1];
			var hourZoom = (double)values[2];
			var daysFromStartOfYear = (int)values[3];
	...
	public class ProcessReportBuilderMarginConverter : IMultiValueConverter
	{
		public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
		{
			if (values[0] == DependencyProperty.UnsetValue)
